...
- Alarm Clock — A simple alarm clock built using Python and `pygame`  
- API Demo (PokéAPI) — Shows how to connect to an external API using Python and `requests`  
- Dice Roller — Simulates rolling dice with ASCII art  
...
1. Clone the repository:
   ```bash
   git clone https://github.com/sunilnarayan419-ui/python.git
   cd python
